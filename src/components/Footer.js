        ...
        <div className="row">
          <div className="col-md-4 mb-5">
            ...
            <div className="d-flex flex-column justify-content-start">
              ...
              <NavLink className="text-secondary mb-2" to="/shop">
                <i className="fa fa-angle-right mr-2" />
                Our Shop
              </NavLink>
              <NavLink className="text-secondary mb-2" to="/shopdetail">
                <i className="fa fa-angle-right mr-2" />
                Shop Detail
              </NavLink>
              <NavLink className="text-secondary mb-2" to="/cart">
                <i className="fa fa-angle-right mr-2" />
                Shopping Cart
              </NavLink>
              <NavLink className="text-secondary mb-2" to="/checkout">
                <i className="fa fa-angle-right mr-2" />
                Checkout
              </NavLink>
