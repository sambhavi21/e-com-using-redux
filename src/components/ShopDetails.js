...
import { DecreaseItemquantity, IncreaseItemquantity, addItemIntoCart } from './Redux/e-com-components/e-com-action'
            ...
            <div className="row px-xl-5">
              ...
              <div className="col-lg-7 h-auto mb-30">
                <div className="h-100 bg-light p-30">
                  ...
                  <h3 className="font-weight-semi-bold mb-4">${getPriceAfterDiscount(item.product.price,item.product.discountPercentage)*item.quantity}</h3>
                  <p className="mb-4">
                  ...
                  <div className="d-flex align-items-center mb-4 pt-2">
                    <div className="input-group quantity mr-3" style={{ width: 130 }}>
                      <div className="input-group-btn">
                        <button onClick={()=>Minus_button(item.product)} className="btn btn-primary btn-minus">
                      ...
                      />
                      <div className="input-group-btn">
                        <button onClick={()=>Plus_button(item.product)} className="btn btn-primary btn-plus">
                          <i className="fa fa-plus" />
                        </button>
                      </div>
                    </div>
                    <button onClick={()=>addToCartHandler(props.product)} className="btn btn-primary px-3">
                ...
                <div className="bg-light p-30">
                  ...
                  <div className="tab-content">
                    <div className="tab-pane fade show active" id="tab-pane-1">
                      <h4 className="mb-3">{item.product.description}</h4>
                      <p>
                    ...
                    <div className="tab-pane fade" id="tab-pane-3">
                      <div className="row">
                        <div className="col-md-6">
                          <h4 className="mb-4">1 review for {item.product.title}</h4>
